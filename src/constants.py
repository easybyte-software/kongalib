...
EB_UM_MISS_FISCALE = 5454
EB_DACF_ASSENTI = 5455
EB_DCFA_ASSENTI = 5456
DATA_IVA_ERR_LIQIVA = 5457                                     #: La data di competenza IVA è anteriore o uguale alla data dell'ultima liquidazione IVA!
...
EB_PARTI_ARTICOLI_RIF_CICLICO = 5462                           #: Non si può specificare un codice articolo che determini un richiamo ciclico!
