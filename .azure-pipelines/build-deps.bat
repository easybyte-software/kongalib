...
md out
cd out
cmake -G "NMake Makefiles" -DPCRE_SUPPORT_UTF=ON -DPCRE_BUILD_PCREGREP=OFF -DPCRE_BUILD_TESTS=OFF -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=%BUILD_SOURCESDIRECTORY%\third_party ..
nmake
nmake install
...
md out
cd out
cmake .. -DOPT_USE_CPP11=1 -DOPT_NO_SSL=1 -DOPT_KONGALIB_WHEEL=1 -DOPT_KONGALIB_ROOT="%BUILD_SOURCESDIRECTORY%" -DTHIRD_PARTY="%BUILD_SOURCESDIRECTORY%\third_party" -DCMAKE_INSTALL_PREFIX=%BUILD_SOURCESDIRECTORY%\third_party -G "NMake Makefiles"
nmake
nmake install
