...
if sys.platform == 'darwin':
	...
	ldflags = '-Wl,-syslibroot,%s -L%s/lib -framework Foundation -lkonga_client_s -lebpr_s -lpcre -lxml2 -lxslt -lz -mmacosx-version-min=%s -headerpad_max_install_names' % (sdk, konga_sdk, macosx_version_min)
