...
if sys.platform == 'darwin':
	...
	ldflags = '-Wl,-syslibroot,%s -L%s/lib -framework Foundation -lkonga_client_s -lebpr_s -lpcre -lxml2 -lz -mmacosx-version-min=%s -headerpad_max_install_names' % (sdk, konga_sdk, macosx_version_min)
	...
	ldflags = '-L%s/lib -lkonga_client_s -lebpr_s -lpcre -lxml2 -lz -ldbus-1' % konga_sdk
	extra_libs = ''
